...
let options = [
    { img: './모바일게임 이미지/냥코.jpeg', text: '냥코' },
    { img: './모바일게임 이미지/라이더.jpeg', text: '라이더' },
    { img: './모바일게임 이미지/마크.jpeg', text: '마인크래프트' },
    { img: './모바일게임 이미지/마피아.jpeg', text: '마피아' },
    { img: './모바일게임 이미지/모두의마블.jpeg', text: '모두의 마블' },
    { img: './모바일게임 이미지/무한의 계단.jpeg', text: '무한의 계단' },
    ...
    { img: './모바일게임 이미지/와일드리프트.jpeg', text: '와일드리프트' },
    { img: './모바일게임 이미지/의지의히어로.jpeg', text: '의지의 히어로' },
