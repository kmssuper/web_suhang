...
let options = [
    ...
    { img: './모바일게임 이미지/배그.png', text: '배틀그라운드' },
    { img: './모바일게임 이미지/브롤스타즈.png', text: '브롤스타즈' },
    { img: './모바일게임 이미지/애니팡.png', text: '애니팡' },
    { img: './모바일게임 이미지/앵그리버드.png', text: '앵그리버드' },
    { img: './모바일게임 이미지/와일드리프트.png', text: '와일드리프트' },
    { img: './모바일게임 이미지/소나.png', text: '소울나이트' },
    { img: './모바일게임 이미지/좀비고.png', text: '좀비고' },
    { img: './모바일게임 이미지/카트라이더.png', text: '카트라이더' },
    { img: './모바일게임 이미지/쿠키런.png', text: '쿠키런' },
