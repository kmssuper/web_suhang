...
let options = [
    ...
    { img: './../PC게임 이미지/발로란트.avif', text: '발로란트' },
    { img: './../PC게임 이미지/배그.png', text: '배틀그라운드' },
    { img: './../PC게임 이미지/서든어택.jpg', text: '서든어택' },
    { img: './../PC게임 이미지/스타.webp', text: '스타크래프트' },
    { img: './../PC게임 이미지/오버워치.webp', text: '오버워치' },
    { img: './../PC게임 이미지/이터널리턴.webp', text: '이터널리턴' },
