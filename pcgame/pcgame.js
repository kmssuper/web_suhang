...
let options = [
    ...
    { img: './image/로블록스.jpg', text: '로블록스' },
    { img: './image/로스트아크.jpg', text: '로스트아크' },
    { img: './image/롤토체스.jpg', text: '롤토체스' },
    { img: './image/리그오브레전드.webp', text: '리그오브레전드' },
    { img: './image/리니지.jpg', text: '리니지' },
    { img: './image/메이플스토리.jpg', text: '메이플스토리' },
    { img: './image/발로란트.jpg', text: '발로란트' },
    { img: './image/배그.png', text: '배틀그라운드' },
    { img: './image/서든어택.jpg', text: '서든어택' },
    { img: './image/스타.webp', text: '스타크래프트' },
