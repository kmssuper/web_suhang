...
let options = [
    ...
    { img: './과목 이미지/부전승.png', text: '옵션 12 설명' },
    { img: './과목 이미지/진로.png', text: '옵션 13 설명' },
    { img: './과목 이미지/부전승.png', text: '옵션 14 설명' },
    { img: './과목 이미지/창체.png', text: '옵션 15 설명' },
    { img: './과목 이미지/부전승.png', text: '옵션 16 설명' },
];
